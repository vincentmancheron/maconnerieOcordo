        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 text-end">
                ...
                <div>
                    ...
                    <a href="https://twitter.com"><img class="img-fluid" src="/assets/img/square-twitter-128.webp" alt="réseau facebook" height="35" width="35"></a>
                </div>
                
            </div>
            <div class="col-12 col-lg-12 text-center">
                <div><a href="/views/mentionsLegales.php">Mentions Légales</a></div>
                <div class="copyright">
                    &copy; Copyright <strong><span>Maçonnerie Ocordo - 2021</span></strong>Tous droits réservés
                </div>
            </div>
        </div>
    </div>
